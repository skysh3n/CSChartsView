#
#  Be sure to run `pod spec lint CSChartsView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Carl_Shen"
  # s.authors            = { "Carl_Shen" => "344208651@qq.com" }
  # s.social_media_url   = "http://twitter.com/Cruise_Shen"
  ...
  s.public_header_files = “CSChartsView.h”
  ...
  # s.library   = "iconv"
  # s.libraries = "iconv", "UIKit”,”Foundation”
